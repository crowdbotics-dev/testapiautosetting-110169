...
## Project Structure
    ...
    ├── testapiautosetting_110169  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_110169`
...
2. Clone this repo and `cd testapiautosetting_110169`
